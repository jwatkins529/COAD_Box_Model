...
This repository contains MATLAB scripts to compute the Δ47, $\Delta$48, and $\Delta$49 of Calcite precipitated from a CO$_2$-fed solution.  If you use this code, I would much appreciate a citation to the following papers:
