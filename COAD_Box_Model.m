...
%Description: This script was used to produce Fig. 6 in Watkins and Devriendt
...
%The post-processing script is 'Run_COAD_Box_Model.m'
%To run, put all files in same directory and execute 'Run_COAD_Box_Model.m'
%Input variables and parameters can be changed in this file. 

%%
function varargout = COAD_Box_Model(varargin)
   [varargout{1:nargout}] = feval(varargin{:});
end

function o=setopts(pH)
    %----------Set parameters----------------------------------------------
    o.TC = 5;
    o.TK = o.TC+273.15;
    o.S = 0;
...
%     o.K0 = exp(o.lnK0);
    ...
    o.RR47_CO2 = 1+o.D47_CO2eq/1000;                                            %Table 4
    o.RR63_HCO3 = 1+o.D63_HCO3eq/1000;                                          %Table 4
    o.RR63_CO3 = 1+o.D63_CO3eq/1000;                                            %Table 4
    o.alpha63_cb = (1+o.D63_CO3eq/1000)/(1+o.D63_HCO3eq/1000);                  %Table 4
    o.K2_63 = o.K2*o.alpha63_cb*o.alpha_cb*o.alpha_cw/o.alpha_bw;               %Table 4
    ...
    o.RR48_CO2 = 1+o.D48_CO2eq/1000;                                            %Table 5
    o.RR64_HCO3 = 1+o.D64_HCO3eq/1000;                                          %Table 5
    o.RR64_CO3 = 1+o.D64_CO3eq/1000;                                            %Table 5
    o.alpha64_cb = (1+o.D64_CO3eq/1000)/(1+o.D64_HCO3eq/1000);                  %Table 5
    o.K2_64 = o.K2*o.alpha64_cb*(o.alpha_cw/o.alpha_bw)^2;                      %Table 5
    %----------Forward k's-------------------------------------------------
